...
velocities_randomize = StringVar()
velocities_randomize.set("COM port list")

positions_randomize = StringVar()
positions_randomize.set("COM port list")
...
drop_down = OptionMenu(root, velocities_randomize, "Port1", "Port2")
connect_button = Button(width=10, height=1, bg = "white", fg= "red", text="Connect")
status_label = Label(width=10, text="Status")
drop_down1 = OptionMenu(root, positions_randomize, "Port3", "Port4")
...
c = Checkbutton(velocities_table_frame, text="Randomize",variable=randomize_velocity_checkbutton_bool)
c2 = Checkbutton(positions_table_top_frame, bg="white", text="Randomize",variable=randomize_position_checkbutton_bool)
